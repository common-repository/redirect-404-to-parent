...
if ( ! function_exists( 'rd404_get_plugin_directory_url' ) ) :
  /**
   * Relative path of the User Activity plugin
   */
  function rd404_get_plugin_directory_url() {
    return plugin_dir_url( __FILE__ );
  }
endif;

if ( ! function_exists( 'rd404_get_plugin_directory' ) ) :
  /**
   * Relative path of the User Activity plugin
   */
  function rd404_get_plugin_directory() {
